...
<body>
    ...
    <div id="encabezado">
        ...
        <div id="menu">
            <ul>
                ...
                <?php
                if (isset($_SESSION["user"]) == false) {
                    echo "<li><a class='enlaceMenu' href='register.php'>Registro</a></li>";
                    echo "<li><a class='enlaceMenu' href='login.php'>Login</a></li>";
                } else {
                    echo "<li><a class='enlaceMenu' href='createNoticia.php'>Crear Noticia</a></li>";
                    echo "<li><a class='enlaceMenuI' href='cerrarSesion.php'>Cerrar sesión</a></li>";
                }
                ?>
            </ul>
    ...
    <script src="js/panelNoticias.js"></script>
</body>
